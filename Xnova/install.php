...
$template->assign_vars(array(
	'lang'			=> $LANG->GetUser(),
	'title'			=> 'Installation de xNova Revolution -Destiny',
	...
	case 'ajax':
		...
		switch($action) {
			...
			case 'install':
				...
				file_put_contents(ROOT_PATH."includes/config.php", sprintf(file_get_contents(ROOT_PATH."includes/config.sample.php"), $database['host'], $database['port'], $database['user'], $database['userpw'], $database['databasename'], $prefix, mt_rand(1000,(int) 9999999999)));
