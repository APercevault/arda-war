 ...
 class GalaxyRows
{
	...
	public function GalaxyRowMoon($GalaxyRowMoon)
	{
		...
		$Result = array(
			...
			'attack_pe'	=> (!CheckModule(50) && $GalaxyRowMoon['id_owner'] != $USER['id']) ? $LNG['type_mission'][16]:false,
			'transport'	=> (!CheckModule(34)) ? $LNG['type_mission'][3]:false,
			'transport_pe'	=> (!CheckModule(34)) ? $LNG['type_mission'][18]:false,
			'stay'		=> (!CheckModule(36) && $GalaxyRowMoon['id_owner'] != $USER['id']) ? $LNG['type_mission'][4]:false,
			'stay_pe'	=> (!CheckModule(36) && $GalaxyRowMoon['id_owner'] != $USER['id']) ? $LNG['type_mission'][19]:false,
			'stayally'	=> (!CheckModule(33) && $GalaxyRowMoon['id_owner'] != $USER['id']) ? $LNG['type_mission'][5]:false,
			'stayally_pe'	=> (!CheckModule(33) && $GalaxyRowMoon['id_owner'] != $USER['id']) ? $LNG['type_mission'][20]:false,
			'spionage'	=> (!CheckModule(24) && $GalaxyRowMoon['id_owner'] != $USER['id']) ? $LNG['type_mission'][6]:false,
			'spionage_pe'	=> (!CheckModule(49) && $GalaxyRowMoon['id_owner'] != $USER['id']) ? $LNG['type_mission'][6]:false,
	...
	public function GalaxyRowPlanet($GalaxyRowPlanet, $IsOwn)
        {
                ...
                $Result = array(
						...
						'transport_pe'             => ($IsOwn || CheckModule(34)) ? false : $LNG['type_mission'][18],
                        'spionage'              => ($IsOwn || CheckModule(24)) ? false : $LNG['type_mission'][6],
						'spionage_pe'              => ($IsOwn || CheckModule(49)) ? false : $LNG['type_mission'][6],
                        'attack'                => ($IsOwn || CheckModule(1)) ? false : $LNG['type_mission'][1],
						'attack_pe'                => ($IsOwn || CheckModule(50)) ? false : $LNG['type_mission'][16],
                        'stay'                  => ($IsOwn || CheckModule(36)) ? false : $LNG['type_mission'][4],
						'stay_pe'                  => ($IsOwn || CheckModule(36)) ? false : $LNG['type_mission'][19],
                        'stayally'              => ($IsOwn || CheckModule(33)) ? false : $LNG['type_mission'][5],
						'stayally_pe'              => ($IsOwn || CheckModule(33)) ? false : $LNG['type_mission'][20],
                );
                return $Result;
        }
