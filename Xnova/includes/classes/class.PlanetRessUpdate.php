...
class ResourceUpdate
{
	...
	private function UpdateRessource()
	{
		...
		$this->DEBUG->log("Inicio de la Actualizacion de Recurso en el Planeta(ID: ".$this->PLANET['id']."): ".date(TIMEFORMAT, $this->PLANET['last_update'])." en ".date(TIMEFORMAT, $this->TIME)." (".pretty_number($this->ProductionTime)."s)");
...
$bulda = 3;
		...
		while ($Loop == true)
		{
			...
			if(($HaveRessources == true) or ($bulda == 3)) {
