...
if(!defined('INSIDE')) die('Hacking attempt!');
	...
	function CreateOneMoonRecord($Galaxy, $System, $Planet, $Universe, $Owner, $MoonID, $MoonName, $Chance, $Size = 0)
	{
		...
		if($Size == 0) {
			$size	= floor(pow(mt_rand(10,(int) 20) + 3 * $Chance, 0.5) * 1000); 
		} else {
			$size	= $Size;
		}
		
		$maxtemp    = $MoonPlanet['temp_max'] - mt_rand(10,(int) 45);
		$mintemp    = $MoonPlanet['temp_min'] - mt_rand(10,(int) 45);
	# case pour la lune	
		$maxcase	= mt_rand(35,(int) 75);
