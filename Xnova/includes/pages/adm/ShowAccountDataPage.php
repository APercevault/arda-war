...
{
	global $USER, $reslist, $resource, $db, $LNG, $UNI, $CONF;
	...
	if (!empty($id_u))
	{
		...
		{
		$retour = "admin.php?page=accoutdata";
		$template->assign_vars(array('message' =>$LNG['ac_username_doesnt'],'retour' =>$retour,));
				...
				if ($PlanetsWhile["destruyed"] > 0)
				{
					$destroyed	.= "
						<tr>
							...
							<td>".date("d-m-Y   ".TIMEFORMAT, $PlanetsWhile['destruyed'])."</td>
						</tr>";	
					$DestruyeD++;
				}
			}
