...
$explo = 1 ;			
	...
	public static function ShowFleet2Page()
	{
		...
		$FleetData	= array(
			...
			'consumption'		=> floattostring($consumption),
							 ...
							 $Planet1 = MAX_PLANET_IN_SYSTEM + 1;  //15
							 $galaxy1 = MAX_GALAXY_IN_WORLD;   //9
							 $system1 = MAX_SYSTEM_IN_GALAXY; // 499
	...
	public static function ShowFleet3Page()
	{
		...
		{
			$template->message("<font size= \"4\" color=\"lime\"><b>".$LNG['fl_empty_transport']."</b></font>", "game.php?page=fleet",10);
			exit;
		}
