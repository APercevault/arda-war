...
{
	global $CONF, $LNG, $PLANET, $USER, $db, $resource, $UNI, $dpath,$NEWS ;
...
$query = $db->query("SELECT user,date,title,text FROM ".NEWS." ORDER BY id ASC");
