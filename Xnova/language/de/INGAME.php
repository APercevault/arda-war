...
# Mercado General
$LNG['mercado_negro'] = "Schwarzmarkt";
$LNG['comerciante'] = "Kaufmann";
$LNG['bonus_n'] = "Anleihe";
$LNG['mercado_negro_desc'] = "In dem Schwarzmarkt Geschäft ist profitabel Ressourcen.";
$LNG['comerciante_desc'] = "Mit dem Kaufmann, können Sie Ihre Schiffe im Austausch für Ressourcen verkaufen.";
$LNG['bonus_n_desc'] = "Sie können gute pakete im Austausch für Dunkle Materie bekommen.";

#Partes extras de otros lugares
$LNG['bd_commander']					= 'Großer Bedarf';

#Oficiales
$LNG['oficiales'] = "Beamte";
$LNG['comandante'] = "Kommandant";
$LNG['comandante_desc'] = "Der Kommandant hat sich in der modernen Kriegsführung gegründet. Wird die Energieeffizienz in Gebäuden zu erhöhen. Sie können sich einen Überblick über dein Imperium zu haben. Dies ermöglicht Ihnen, Strukturen, die Sie einen Schritt näher an den Feind nehmen zu entwickeln. <br /><br /> <font color=skyblue>Vision des Reiches, Tail-Strukturen und Bau, Gebäudetechnik maximale Taste im Hangar, -10% der Zeit in allen Gebäuden.</font> ";
$LNG['geologo'] = "Geologe";
$LNG['geologo_desc'] = "Der Geologe ist ein Experte in astrominerologíay astrocristalografía. Unterstützt durch sein Team von Metallurgen und Chemieingenieure im interplanetaren Regierung unterstützt die Ausbeutung von Ressourcen und Quellen optimazación Verfeinerung dieser Ressourcen.<br /><br /><font color=skyblue>+10% Steigerung der Produktion von Minen und disimnuye von 20% der Baukosten.</font>";
$LNG['ingeniero'] = "Ingenieur";
$LNG['ingeniero_desc'] = "Der Ingenieur ist ein Spezialist für Energiemanagement. In Friedenszeiten erhöht die Energie aller Kolonien. Im Falle eines Angriffs, garantiert die Lieferung von Waffen energíaa, die Vermeidung einer möglichen Überlastung, die zu einer Verringerung der Verluste in der Schlacht Abwehrkräfte führt.<br /><br /><font color=skyblue>-10% weniger Energieverbrauch.</font>";
$LNG['almirante'] = "Admiral";
$LNG['almirante_desc'] = "Der Admiral ist ein erfahrener Veteran und ein geschickter Stratege. In der härtesten Schlachten der Lage ist, eine Vorstellung von den Admirale bekommen situacióny sich an ihren Untergebenen. Ein weiser Kaiser kann auf ihre Hilfe während der Kämpfe verlassen und führen mehr Flotten gleichzeitig.<br /><br /><font color=skyblue>Erhöht die Flotte in zwei Räume zur Verfügung und eine zusätzliche Stunde in der Grenze von Tiemo Expeditionen.</font>";
$LNG['tecnocrata'] = "Technokrat";
$LNG['tecnocrata_desc'] = "Die Technokraten Gilde wird von Genies komponiert und immer finden sie in einer Welt, in der menschlichen Logik verworfen werden würde. Seit Tausenden von Jahren hat kein normaler Mensch entziffern können der Code eines Technokraten. Der Technokrat inspiriert Forscher Reich mit nur seine Anwesenheit.<br /><br /><font color=skyblue>Erhöhte sich um +2 Spionage Ebene.<br /> -25% Abnahme Forschungszeit.</font>";
$LNG['contratar'] = "Mieten";
$LNG['semana'] = "Woche";
$LNG['mes'] = "Monate";
$LNG['activo'] = "Aktiv";
$LNG['inactivo'] = "Inaktiv";
$LNG['nivel_maximo'] = "Maximum Level";
$LNG['oficial_contratado'] = "<b>Offizielle Vertrag von heute arbeitet für Ihr Reich.</b>";
$LNG['materia_oscura'] = "Dunkle Materie ist eine Substanz, die nur mit großem Aufwand und nur vor ein paar Jahren Standard gespeichert werden. Sie können große Mengen an Energie aus ihr zu erhalten, aber die Methode, um dunkle Materie zu gewinnen ist komplex und voller Risiken, wurde es so wertvoll...";
$LNG['comprar'] = "Kaufen";

#Materia Oscura Mercader
$LNG['dm_pack_no'] = "Nicht genug, um dieses Paket Norium kaufen.";
$LNG['dm_pack_ok'] = "Sie kaufte diese Packung.";
$LNG['de_materia'] = " Dunkle Materie";
$LNG['caja'] = "Box #";
