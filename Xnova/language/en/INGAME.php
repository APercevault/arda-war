...
# Mercado General
$LNG['mercado_negro'] = "Black Market";
$LNG['comerciante'] = "Merchant";
$LNG['bonus_n'] = "Bonus";
$LNG['mercado_negro_desc'] = "In the black market business is profitable resources.";
$LNG['comerciante_desc'] = "With the merchant, you can sell your ships in exchange for resources.";
$LNG['bonus_n_desc'] = "You can get good packs in exchange for Dark Matter.";

#Partes extras de otros lugares
$LNG['bd_commander']					= 'You need the Commander';

#Oficiales
$LNG['oficiales'] = "Officials";
$LNG['comandante'] = "Commander";
$LNG['comandante_desc'] = "The Commandant has established itself in modern warfare. Will increase efficiency in buildings. You will be able to have an overview of your empire. This allows you to develop structures that take you one step closer to your enemy.<br /><br /> <font color=skyblue>Vision of Empire, Tail structures and construction technology, building maximum button in the hangar, -10% of time in all buildings.</font> ";
$LNG['geologo'] = "Geologist";
$LNG['geologo_desc'] = "The geologist is an expert in astrominerologíay astrocristalografía. Supported by his team of metallurgists and chemical engineers in interplanetary government supports the exploitation of resources and sources optimazación refinement of these resources.<br /><br /><font color=skyblue>+10% Increase in production of mines and decrease by 20% the cost of construction.</font>";
$LNG['ingeniero'] = "Engineer";
$LNG['ingeniero_desc'] = "The Engineer is a specialist in energy management. In peacetime increases the energy of all the colonies. In case of attack, guarantees the supply of energíaa guns, avoiding a possible overload, which leads to a reduction of losses in battle defenses.<br /><br /><font color=skyblue>10% decrease in energy consumption.</font>";
$LNG['almirante'] = "Admiral";
$LNG['almirante_desc'] = "The Fleet Admiral is an experienced veteran and a skilled strategist. In the hardest battles, is able to get an idea of ??the admirals situacióny contact their subordinates. A wise emperor can rely on their help during the fighting and lead more fleets at the same time.<br /><br /><font color=skyblue>Increases in fleet +2 spaces available and an extra hour in the limit of tiemo expeditions.</font>";
$LNG['tecnocrata'] = "Technocrat";
$LNG['tecnocrata_desc'] = "The Technocrats Guild is composed of geniuses and always find them in a world where human logic would be discarded. For thousands of years, no normal human being has been able to decipher the code of a technocrat. The technocrat inspires researchers empire with just his presence.<br /><br /><font color=skyblue>Increased by +2 espionage level. <br /> -25% Decrease research time.</font>";
$LNG['contratar'] = "Hire";
$LNG['semana'] = "Week";
$LNG['mes'] = "Months";
$LNG['activo'] = "On";
...
$LNG['oficial_contratado'] = "<b>Official contract from today works for your empire.</b>";
$LNG['materia_oscura'] = "Dark Matter is a substance that can be stored only with great effort and only a few years ago standard. You can obtain large amounts of energy from it, but the method to gain dark matter is complex and full of risks, it became so valuable...";
$LNG['comprar'] = "Buy";

#Materia Oscura Mercader
$LNG['dm_pack_no'] = "Not enough to buy this pack norio.";
$LNG['dm_pack_ok'] = "You bought this pack.";
$LNG['de_materia'] = " of Dark Matter";
$LNG['caja'] = "Box #";
