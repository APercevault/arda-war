...
# Mercado General
$LNG['mercado_negro'] = "Borsanera";
$LNG['comerciante'] = "Commerciante";
$LNG['bonus_n'] = "Legame";
$LNG['mercado_negro_desc'] = "Nel business del mercato nero sono le risorse redditizie.";
$LNG['comerciante_desc'] = "Con il commerciante, potete vendere le vostre navi in cambio di risorse.";
$LNG['bonus_n_desc'] = "È possibile ottenere pacchetti di buoni in cambio di Dark Matter.";

#Partes extras de otros lugares
$LNG['bd_commander']					= 'Need Maggiore';

#Oficiales
$LNG['oficiales'] = "Ufficiales";
$LNG['comandante'] = "Comandante";
$LNG['comandante_desc'] = "Il comandante si è affermata nella guerra moderna. Aumenterà l'efficienza negli edifici. Sarete in grado di avere una visione d'insieme del tuo impero. Questo permette di sviluppare le strutture che si prendono un passo avanti verso il nemico. <br /> <br /> <font color=skyblue> Vision of Empire, strutture di coda e la tecnologia di costruzione, la costruzione di pulsante massima nell'hangar, -10% del tempo in tutte le edifici. </ font> ";
$LNG['geologo'] = "Geologo";
$LNG['geologo_desc'] = "Il geologo è un esperto in astrominerologíay astrocristalografía. Supportato dal suo team di ingegneri chimici e metallurgici nel governo interplanetario sostiene lo sfruttamento delle risorse e fonti di perfezionamento optimazación di queste risorse. <br /> <br /> Font <color = skyblue> Aumento +10% nella produzione di miniere e disimnuye del 20% del costo di costruzione. </ font>";
$LNG['ingeniero'] = "Ingegnere";
$LNG['ingeniero_desc'] = "L'Ingegnere è uno specialista nella gestione dell'energia. In tempo di pace aumenta l'energia di tutte le colonie. In caso di attacco, garantisce la fornitura di pistole energíaa, evitando un eventuale sovraccarico, che porta ad una riduzione delle perdite in difese battaglia. <br /> <br /> <font color=skyblue> 10% di riduzioni nel consumo di energia. </ font>";
$LNG['almirante'] = "Ammiraglio";
$LNG['almirante_desc'] = "L'ammiraglio della flotta è un veterano esperto e un abile stratega. Nelle battaglie più difficili, è in grado di avere un'idea degli ammiragli situacióny contattare i loro subordinati. Un imperatore saggio può contare sul loro aiuto durante i combattimenti e portare più flotte allo stesso tempo. <br /> <br /> <font Color=skyblue> +2 aumenti negli spazi della flotta a disposizione e un'ora in più nel spedizioni limite Tiemo. </ font>";
$LNG['tecnocrata'] = "Tecnocrate";
$LNG['tecnocrata_desc'] = "The Guild tecnocrati è composta da geni e sempre a trovare in un mondo dove la logica umana sarebbe stato scartato. Per migliaia di anni, nessun essere umano normale è stata in grado di decifrare il codice di un tecnocrate. Il tecnocrate ispira impero ricercatori con la sua sola presenza. <br /> <br /> <font color=skyblue> +2 aumenti del livello di spionaggio. <br /> -25% Riduzione tempi di ricerca. </ font>";
$LNG['contratar'] = "Noleggio";
$LNG['semana'] = "Settimana";
$LNG['mes'] = "Mesi";
$LNG['activo'] = "Attivo";
$LNG['inactivo'] = "Inattivo";
$LNG['nivel_maximo'] = "Livello massimoo";
$LNG['oficial_contratado'] = "<b>Contratto ufficiale da oggi funziona per il vostro impero.</b>";
$LNG['materia_oscura'] = "La materia oscura è una sostanza che può essere conservato solo con grande sforzo e solo pochi anni fa standard. È possibile ottenere grandi quantità di energia da esso, ma il metodo per ottenere la materia oscura è complessa e piena di rischi, è diventato così prezioso...";
$LNG['comprar'] = "Comprare";

#Materia Oscura Mercader
$LNG['dm_pack_no'] = "Non abbastanza per acquistare questo pacchetto di Norio.";
$LNG['dm_pack_ok'] = "Hai comprato questo pacchetto.";
$LNG['de_materia'] = " Dark Matter";
$LNG['caja'] = "Scatola #";
...
$LNG['al_nivel_error']								= '<center><img width="120" height="120" src="styles/theme/gultra/imagenes/otros/rangos/3.png" /></center><br /><b>Devi essere almeno di livello 3 per creare un\'alleanza.<br /> Per arrivare al livello 3 devi avere pi&ugrave di 10.000 punti.</b>.';
