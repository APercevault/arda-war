...
$LNG['intro_welcome']			= "Bemvindo ao xNova Revolution!";
$LNG['intro_text']				= "Bemvindo a um dos melhores clones do OGame , o xNova Revolution<br>A versão mais recente xNova Revolution porque a taxa fixa foi já desenvolvido. xNova Revolution brilha pela estabilidade, flexibilidade, dinâmica, qualidade e facilidade de utilização. Desejamos sempre ser melhor do que suas expectativas.<br><br>Os guias de instalação do sistema através da instalação ou atualização de uma versão mais antiga para a mais Na dúvida ou problema não hesite em contactar-nos (xNova Revolution.cc).<br><br>xNova Revolution é um projeto de código aberto licenciado sob a GNU GPL v3. Para obter a licença, clique no item do menu.<br><br>Antes da instalação começar, um teste é realizado, se os requisitos do sistema são atendidas.";
$LNG['reg_yes']					= "Sim";
$LNG['reg_no']					= "Não";
