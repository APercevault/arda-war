...
$LNG['cazador'] = "Caçador";
$LNG['civil'] = "Nave Civil";
$LNG['cruceros'] = "Cruzador";
$LNG['insignia'] = "Nave de Batalha";
$LNG['capital'] = "Nave de Destruição";

# Combates
$LNG['tech_rc'] = array (
202 => 'Cg.Pequeno', # Fragatas 
203 => 'Cg.Grande',  # Fragatas
204 => 'Caça L.', # Cazador
205 => 'Caça P.', # Cazador
206 => 'Cruzador', # Cruceros
207 => 'N.Batalha', # Cruceros 
208 => 'N. Colonização',  # Civil
209 => "Recicladores",  # Fragatas
210 => 'Sonda', # Civil
211 => 'Bombardeiro.',  # Naves Insignia 
212 => 'Sat.Solar', # Civil
213 => 'Destruidor', # Naves Insignia
214 => 'E. da Morte', # Naves capitales
215 => 'Interceptor', # Naves Insignia
216 => 'Aurora',# Naves capitales
217 => 'Cg. Autentico',  # Fragatas
218 => 'Nodras', # Naves capitales
219 => 'Grande Reciclador',  # Fragatas
220 => 'Sondador de MN',  # Civil
...
123 => "Rede Intergalática",
124 => 'Expedição',
131 => 'Produção de Metais',
132 => 'Produção de Cristais',
135 => 'Produção de Semi-Cristais',
133 => 'Produção de Hidrogénio',
134 => 'Manipulador de Matéria',
...
217 => 'Super Cargueiro',
218 => 'Norda',
219 => 'Grande Reciclador',
220 => 'Sondador de Matéria Negra',
...
409 => 'S. Escudo Planetário',
410 => 'Canhão de Gravitação',
411 => 'Sistema Orbital de Defesa',
...
7 => "O Nório e uma matéria que existe em vão no teu planeta , se extrai do nucleo do planeta e é um elemento com priopiedades muito uteis.",
...
131 => 'Aumenta a produção da mina de metal em 2%',
132 => 'Aumenta a produção da mina de cristal em 2%',
133 => 'Aumenta a produção do sintetizador em deuterio por 2%',
199 => "Um gráviton é uma partícula elementar responsável pelos efeitos da gravitação.",
134 => 'A Matéria Negra é um recurso demasiado caro e aquele que o possui em grandes quantidades é milionário. Para sua conservação necessita de tecnologia de ponta, e com essa tecnologia desenvolve-se métodos de extracção de matéria negra na lua e melhora-se os métodos existentes para o seu mantimento.',
135 => 'É dificil de chegar perto do núcleo do planeta e  conservar o Nório recolhido à superficie. O Nório extrai-se do fundo em estado liquido e quando chega à superficie, torna-se sólido.',
...
217 => 'Este é o sucessor do cargeiro grande, o Super Cargueiro , com uma capacidade de carga muito acima do normal, e mais rápido que o seu anterior, faz desta nave um supremo monstro de carga.',
218 => 'Esta pode ser chamada a nave de destruição mas nem tudo são vantagens, o seu tamanho faz desta nave um monstro lento.',
219 => 'O Grande Reciclador é uma nave muito desejada devido à sua capacidade de carga e velocidade.',
...
$LNG['info'][7]['description'] = "O Nório e uma matéria que existe em vão no teu planeta , se extrai do nucleo do planeta e é um elemento com priopiedades muito uteis.";
...
// ----------------------------------------------------------------------------------------------------------
// Edificios
$LNG['info'][6]['name']          = "Universidade";
$LNG['info'][6]['description']   = "Os cientistas juntaram-se para criar uma forma de poderem reduzir o tempo das pesquisas, então criaram a universidade que por cada nivel irá reduzir o tempo de construção das pesquisas";
...
$LNG['info'][25]['description']  			= "Cada evolução do armazém de nório permite o aumento da capacidade de armazenamento. Se a capacidade máxima do armazém é atingida, a produção de nório é interrompida";
...
// ----------------------------------------------------------------------------------------------------------
// Edificios Lunares ou Especiais
...
$LNG['info'][121]['name']        = 'Tecnologia de Iões';
$LNG['info'][121]['description'] = 'Ao acelerar iões um raio letal é criado, e causa danos importantes aos objectos que atinge.';
$LNG['info'][122]['name']        = 'Tecnologia de Plasma';
$LNG['info'][122]['description'] = 'Tecnologia mais avançada que a tecnologia de iões, em vez de acelerar iões, acelera-se o plasma com um grande poder energético, desta forma cria-se um raio que ocasiona danos enormes aos objectos que atinge.';
...
$LNG['info'][135]['name']        = 'Tecnologia de Produção de Semi-Cristais';
$LNG['info'][135]['description'] = 'EÉ dificil de chegar perto do nucleo do planeta e  conservar o Nório recolhido à superficie. O Nório extrai-se do fundo em estado liquido e quando chega à superficie, torna-se sólido.';
$LNG['info'][134]['name'] = 'Manipulador da Matéria';
$LNG['info'][134]['description'] = 'A Matéria Negra é um recurso demasiado caro e aquele que o possui em grandes quantidades é milionario. Para sua conservação necessita de tecnologia de ponta, e com essa tecnologia desenvolves metodos de extracção de matéria negra na lua e melhoras os metodos existentes para seu mantimento.';
...
$LNG['info'][217]['name']        = 'Super Cargueiro';
$LNG['info'][217]['description'] = 'Este é o sussecor do cargeiro Grande, o Super Cargueiro, com uma capacidade de carga muito acima do normal, e mais rápida que o seu anterior, faz desta nave um supremo monstro de carga.';
$LNG['info'][218]['name']        = 'Norda';
$LNG['info'][218]['description'] = 'Esta pode ser chamada a nave de destruição mas nem tudo são vantagens, o seu tamanho faz desta nave um monstro lento. Mas muito usada para limpar planetas com bunkers.';
$LNG['info'][219]['name']        = 'Grande Reciclador';
...
$LNG['info'][220]['name']        = 'Sondador de Matéria Negra';
...
$LNG['info'][409]['name']        = 'Super Escudo Planetário';
$LNG['info'][409]['description'] = 'O Super escudo planetário cobre o planeta para absorver quantidades enormes de tiros. A sua resistência é muito maior daquela encontrada no grande escudo planetário e francamente resistente contra o RapidFire das naves de combate.';
...
$LNG['info'][411]['name']        = 'Sistema Orbital de Defesa';
