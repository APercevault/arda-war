...
$LNG['bonus_n'] = "Bonus";
$LNG['mercado_negro_desc'] = "No negócio de mercado negro são os recursos rentáveis.";
$LNG['comerciante_desc'] = "Com o comerciante, você pode vender seus navios em troca de recursos.";
$LNG['bonus_n_desc'] = "Você pode obter pacotes de boas em troca de matéria escura.";

#Partes extras de otros lugares
$LNG['bd_commander']					= 'Grande necessidade';

#Oficiales
$LNG['oficiales'] = "Oficial";
$LNG['comandante'] = "Comandante";
$LNG['comandante_desc'] = "O comandante estabeleceu-se na guerra moderna. Irá aumentar a eficiência nos edifícios. Você será capaz de ter uma visão geral de seu império. Isto permite-lhe desenvolver estruturas que levam você a um passo de seu inimigo. <br /> <br /> <font color=skyblue> Visão do Império, as estruturas da cauda e tecnologia de construção, a construção de botão máxima no hangar, -10% do tempo em toda edifícios. </ font>";
$LNG['geologo'] = "Ge&oacute;logo";
$LNG['geologo_desc'] = "O geólogo é um especialista em astrominerologíay astrocristalografía. Apoiado por sua equipe de metalúrgicos e engenheiros químicos no governo interplanetário suporta a exploração dos recursos e fontes de refinamento optimazación desses recursos. <br /> <br /> Cor da fonte <= skyblue> Aumento 10% na produção de minas e disimnuye em 20% o custo da construção. </ font>";
$LNG['ingeniero'] = "Engenheiro";
$LNG['ingeniero_desc'] = "O Engenheiro é um especialista em gestão de energia. Em tempos de paz aumenta a energia de todas as colônias. Em caso de ataque, garante o fornecimento de armas energíaa, evitando uma sobrecarga possível, o que conduz a uma redução das perdas nas defesas de batalha. <br /> <br /> <font color=skyblue> diminui 10% no consumo de energia. </ font>";
$LNG['almirante'] = "Almirante";
$LNG['almirante_desc'] = "O almirante da frota é um veterano experiente e estrategista habilidoso. Nas batalhas mais duras, é capaz de ter uma idéia dos almirantes situacióny entre em contato com seus subordinados. Um sábio imperador pode contar com sua ajuda durante a luta e levar frotas mais ao mesmo tempo. <br /> <br /> <font Color=skyblue> +2 Aumenta em espaços disponíveis da frota e uma hora extra no expedições limite tiemo. </ font>";
$LNG['tecnocrata'] = "Tecn&oacute;crata";
$LNG['tecnocrata_desc'] = "The Guild tecnocratas é composto de gênios e sempre encontrá-los em um mundo onde a lógica humana seria descartado. Por milhares de anos, nenhum ser humano normal tem sido capaz de decifrar o código de um tecnocrata. O tecnocrata inspira império pesquisadores com apenas a presença dele. <br /> <br /> <font color=skyblue> +2 aumentos no nível de espionagem. tempo de pesquisa <br /> -25% Redução. </ font>";
$LNG['contratar'] = "Contratar";
$LNG['semana'] = "Semana";
$LNG['mes'] = "Meses";
$LNG['activo'] = "Activo";
$LNG['inactivo'] = "Inativo";
$LNG['nivel_maximo'] = "Nivel Maximo";
$LNG['oficial_contratado'] = "<b>Contrato oficial a partir de hoje trabalha para o seu império.</b>";
$LNG['materia_oscura'] = "Dark Matter é uma substância que pode ser armazenado somente com muito esforço e poucos anos atrás padrão. Você pode obter grandes quantidades de energia a partir dele, mas o método para obter a matéria escura é complexo e cheio de riscos, tornou-se tão valioso...";
$LNG['comprar'] = "Comprar";

#Materia Oscura Mercader
$LNG['dm_pack_no'] = "Não o suficiente para comprar este pacote de Norio.";
$LNG['dm_pack_ok'] = "Você comprou este pacote.";
$LNG['de_materia'] = " de Dark Matter";
$LNG['caja'] = "Caixa #";
