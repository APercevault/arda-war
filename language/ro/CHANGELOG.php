...
- FIX: JQuery Boxs
- FIX: Conoly Mission
- FIX: Apostrophe in italian messagge
- FIX: Shield can more build more than 1
- ADD: New officiers system 
...
- FIX: Calculate Steal
- FIX: Recycling
- FIX: Resource Production Bonus From Research 
- FIX: Add slots for ACS in Battlesim
- FIX: Fixed field hack
- FIX: Install by  
- FIX: Update of messages 
...
- FIX: Reduction from tech research from university
...
- FIX: FlyingFleets Table add resource info
- FIX: Show resources on builds
- FIX: ReseachPage Bug
- FIX: Current resources on Topnav
- FIX: Redesign for others languages
- FIX: Destroy build level 0
- FIX: Ghost ship on fleets
- FIX: CombatRaports on hallf of fame whites
...
- FIX: Research warning
- FIX: No resource Expedition 
- FIX: Dialog Playcard Galaxy
- FIX: Crystal debris
- FIX: Battlesim
- FIX: Found ships on Expedition
- FIX: PlanetRessUpdate
- FIX: Fleet error
- FIX: Research building list 
- FIX: Recycler mission
- FIX: Division by zero and Wrong Max Energy by Norium
- FIX: Adm fleet bug 

<b>Important:</b> The images of structures, defense, technology, ships and some property owners are Gameforge GmbH.

The design was created by <a href="" target="_blank">Destiny</a><br />
',
...
- MOD: Display fleets in enemy planets
- MOD: Improved style and a small function on GenerateReport
...
New version of 2moons created by <a href="http://princk.deviantart.com/" target="_blank">Destiny</a> .<br />
',
);
?>