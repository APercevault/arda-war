				...
				<div class="left-col">
					<ul class="login">
						...
						<li>
							...
							<div class="bg"><input id="character" name="character" class="text" type="text" value="" alt="{$user_reg}" maxlength="18" /></div>
						</li>
						<li>
						...
						<li>
							...
							<div class="bg"><input id="password" name="password" class="text" type="password" value="" alt="{$pass_reg}" maxlength="16" /></div>
						</li>
												<li>
							<label for="userpass">{$pass2_reg}</label>
							<div class="bg"><input id="password2" name="password2" class="text" type="password" value="" alt="{$pass2_reg}" maxlength="16" /></div>
						</li>
												<li>
							<label for="username">{$planet_reg}</label>
							<div class="bg"><input id="planet" name="planet" class="text" type="text" value="" alt="{$planet_reg}" maxlength="18" /></div>
						</li>
...
<div id="footer">
						...
						<ul>
							...
							<img src="./styles/images/login/fr.png"  width="16" height="11"></a>
							</ul>
					</div>
				</div>
			</div>
