...
<td><input colspan"2" type="button" onClick="window.location='game.php?page=galaxy&mode=5'" name="button" value="  CONFIRMER le deplacement VSL du vaisseau  " </td>
<td><input colspan"2" type="button" onClick="window.location='game.php?page=galaxy'" name="button" value="  ANNULER le deplacement VSL du vaisseau  " </td>
...
<td><input type="button" onClick="window.location='game.php?page=galaxy&mode=10'" name="button" value="Votre Vaisseau arrive a destination . Prochain saut entre 4 a 7 jours , Appuyer ICI " </td>
...
{else}
	...
	{if $GalaxyRow.planet}
	<td><a class="tooltip_sticky" name="<table style='width:320px'>
	<tr>
	...
	<br />
	{/if}
	{if $GalaxyRow.planet.stay}<a href='?page=fleet&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=1&amp;target_mission=4'>{$GalaxyRow.planet.stay} ( Spatial )</a>
	<br />
	{/if}
	...
	<tr>
	<td style='width:80'><img src='styles/theme/{$Raza_skin}/planeten/small/debris.jpg' height='75' style='width:75' />
	</td>
	...
	{elseif empty($GalaxyRow) && $planet_depla == 0 && $planet_type == 1}
...
<img src="{$dpath}imagenes/planeta_o.png" height="30" width="40" /></td><td style="white-space: nowrap;"> <a class=" tooltip"  name="Coloniser" href="game.php?page=fleet&galaxy={$galaxy}&system={$system}&planet={$planet}&planettype=1&target_mission=7" onmouseover="document.co.src='{$dpath}imagenes/otros/c1.png'" onmouseout="document.co.src='{$dpath}imagenes/otros/c.png'"><img name="co" src="{$dpath}imagenes/otros/c1.png"></a> <td style="white-space: nowrap;"><img src="{$dpath}imagenes/luna_o.png" height="22" width="22" /></td><td style="white-space: nowrap;"><img src="{$dpath}imagenes/escombro_o.png" height="22" width="22" /></td><td>-</td><td>-</td><td style="white-space: nowrap;">-</td>

	{elseif empty($GalaxyRow)}
<td><img class="tooltip" name="{$inavitado1}" src="{$dpath}imagenes/planeta_o.png" height="30" width="40" /></td><td style="white-space: nowrap;"> <a class=" tooltip"  name="Coloniser" href="game.php?page=fleet&galaxy={$galaxy}&system={$system}&planet={$planet}&planettype=1&target_mission=7" onmouseover="document.co.src='{$dpath}imagenes/otros/c1.png'" onmouseout="document.co.src='{$dpath}imagenes/otros/c.png'"><img name="co" src="{$dpath}imagenes/otros/c1.png"></a> <td style="white-space: nowrap;"><img src="{$dpath}imagenes/luna_o.png" height="22" width="22" /></td><td style="white-space: nowrap;"><img src="{$dpath}imagenes/escombro_o.png" height="22" width="22" /></td><td>-</td><td>-</td><td style="white-space: nowrap;">-</td>

	{else}
	<td><img class="tooltip" name="{$planet_destroyed}" src="styles/theme/{$Raza_skin}/imagenes/planeta_o.png" height="30" width="40" /></td><td style="white-space: nowrap;">-</td><td style="white-space: nowrap;"><img src="styles/theme/{$Raza_skin}/imagenes/luna_o.png" height="22" width="22" /></td><td style="white-space: nowrap;"><img src="styles/theme/{$Raza_skin}/imagenes/escombro_o.png" height="22" width="22" /></td><td>-</td><td>-</td><td style="white-space: nowrap;">-</td>
	{/if}
	</tr>
	{/foreach}
...
{/if}	
{if !CheckModule(55)}	
		<a href="?page=etoile&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$smarty.const.MAX_PLANET_IN_SYSTEM + 1}&amp;planettype=1&amp;target_mission=15">.....{$gl_out_space1}.....</a>
{/if}		
		</td>
		<td>
