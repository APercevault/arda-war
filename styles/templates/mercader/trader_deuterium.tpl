...
<div id="titulo_alternativo">
    <ul class="tabsbelow">
        <li>
<span><B><font color = yellow size = 2>{$echange_deuterium}</font></B> <a class="right" href="game.php?page=trader"><b><font color="red" size = 2>>></font> <font size = 2>{$al_back}</font></b></a></span>
        </li>                                    
    </ul>
</div>
<div id="eins">
     ...
     <table cellspacing="0" cellpadding="0" id="mercado_tabla" >
			<tbody><tr>
				...
				<tr class="alt_2">
					...
					<td class="noCenter"><b><font color = yellow size = 2 >{$Metal}</font></b></td>
						<td>
							<div class="bg_input1"><input name="metal" class="text" id="metal" type="text" value="0" onkeyup="calcul('{$ress}')" style="text-align: right;" size="10" class="textinput" /></div>
						</td>
				...
				<tr class="alt">
					...
					<td class="noCenter"><font size = 2>{$Deuterium}</td>
