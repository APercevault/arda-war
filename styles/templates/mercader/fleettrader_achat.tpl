...
<div id="titulo_alternativo">
    <ul class="tabsbelow">
        <li>
<span><B><font color =yellow size = 2>{$vente_comerciante}</font><font size = 2>{$taxecommercant}</font><font color = white size = 2>{$Charge}% </font><font color =yellow size = 2 id="blaa" style="visibility:visible">{$achat}</font></B> <a class="right" href="game.php?page=fleettrader"><b><font color="red" size = 2>>></font> <font size = 2>{$al_back}</font></b></a></span>	
        </li>                                    
    </ul>
</div>
<div id="eins">
...
<table width="96%">
		<tbody>
			...
			<tr>
			<td class="remarcado">
			<select name="ida" id="id" onChange="updateVars1()">
			...
			<input type="text" class="text" id="count" name="count" onkeyup="Total1();" />
			<br><br><input type="button" class="submit" value="Maximum" onclick="MaxShips1();">
			</div>
			</td>
