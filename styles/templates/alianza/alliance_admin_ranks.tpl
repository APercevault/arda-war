...
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
            <span><b><font color="yellow" size = 2>{$al_configura_ranks}</font></b> <a class="right" href="game.php?page=alliance&amp;mode=admin&amp;edit=ally"><b><font color="red" size = 2 >>></font><font size = 2>{$al_back}</font></b></a></span>
        </li>                                    
    </ul>
</div>	
<div id="eins">
<div>		
	...
	{/foreach}
	<tr>
		<td colspan="11"><center><input class="submita" type="submit" value="{$al_save}"></td>
	</tr>
    </table>
	</form>
</div>			
...
<div id="titulo_alternativo_secundario">
    <ul class="tabsbelow">
        <li>
              <span><b><font color="yellow" size = 2>{$al_create_new_rank}</font></b></span>
        </li>                                    
    </ul>
</div>	
<div id="eins">
<div>			
    ...
    <table style="width:95%">
        ...
        <tr>
          <td colspan="2"><center><input class="submit" type="submit" value="{$al_create}"></td>
        </tr>
    </table>
    </form>
</div>			
