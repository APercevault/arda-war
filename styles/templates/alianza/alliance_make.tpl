...
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
 <span><b><font color="yellow" size = 2>{$al_make_alliance}</font></a></b> <a class="right" href="game.php?page=alliance"><b><font color="red" size = 2 >>></font><font size = 2>{$al_back}</font></b></a></span>
...
<br />
   <form action="game.php?page=alliance&amp;mode=make&amp;action=send" method="POST">
        <table width="95%">
            <tr>
                <td><h3><font color = lime size = 2>{$al_make_ally_tag_required}</font></h3></td>
                <td><div class="bg_input_special"><input type="text" class="text" name="atag" size="8" maxlength="8" value=""></div></td>
            </tr>
            <tr>
                <td><h3><font color = lime size = 2>{$al_make_ally_name_required}</font></h3></th>
