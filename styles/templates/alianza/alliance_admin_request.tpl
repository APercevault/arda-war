...
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
              <span><b><font color="yellow" size = 2>{$al_request_list}</font></b> <a class="right" href="game.php?page=alliance"><b><font color="red" size = 2>>></font> <font size = 2>{$al_back}</font></b></a></span>	
        </li>                                    
    </ul>
</div>	
<div id="eins">
...
<div id="titulo_alternativo_secundario">
    <ul class="tabsbelow">
        <li>
              <span><b><font color="yellow" size = 2>{$al_request_from_user} : </font> <font color="orange" size = 2 > {$RequestRow.username}<font></b></span>
        </li>                                    
    </ul>
</div>	
<div id="eins">
