...
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
              <span><b><a href="javascript:allydiplo('new',0,0);"><font color="yellow" size = 2>{$al_diplo_create}</font></a></b> <a class="right" href="game.php?page=alliance&amp;mode=admin&amp;edit=ally"><b><font color="red" size = 2 >>></font><font size = 2>{$al_back}</font></b></a></span>
        </li>                                    
    </ul>
</div>	
<div id="eins">
