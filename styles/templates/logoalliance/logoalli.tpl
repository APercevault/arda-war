...
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
              <span><b><font color="yellow" size = 2>{$al_change_logo}</font></b><a class="right" href="game.php?page=alliance&mode=admin&edit=ally"><b><font color="red" size = 2>>></font> <font size = 2>{$al_back}</font></b></a></span>
        </li>                                    
    </ul>
</div>
...
<p>	
<br />	
<form method="post" enctype="multipart/form-data" action="game.php?page=alliance&mode=admin&edit=ally">
