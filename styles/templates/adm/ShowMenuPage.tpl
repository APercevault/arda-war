...
<div id="leftmenu">
	<ul id="menu">
		<li style="background-image: url('./styles/theme/gultra/img/menu-top.png');height:100px;"></li>
		...
		<li style="background-image: url('./styles/theme/gultra/img/menu-foot.png');height:30px;"></li>
	</ul>
</div>