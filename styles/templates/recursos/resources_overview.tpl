...
<div id="eins">
	...
	<td><img class="tooltip" name="{$Metal}" src="styles/theme/{$Raza_skin}/images/metal.jpg" /></td>	
        ...
        <td><b><font color = yellow>{$rs_basic_income}</font></b></td>
        <td class="semi_remarcado"><b><font color = yellow>{$metal_basic_income}</font></b></td>
        <td class="semi_remarcado"><b><font color = yellow>{$crystal_basic_income}</font></b></td>
        <td class="semi_remarcado"><b><font color = yellow>{$deuterium_basic_income}</font></b></td>
        <td class="semi_remarcado"><b><font color = yellow>{$norio_basic_income}</b></font></td>		
        <td class="semi_remarcado"><b><font color = yellow>{$energy_basic_income}</font></b></td>
    </tr>
	...
	<tr>
		...
		<td class="semi_remarcado"><h3 class="tooltip" name="{$CurrPlanetInfo.irs_met}">{$CurrPlanetInfo.metal_type}</h3></td>
		
		<td class="remarcado"><h3 class="tooltip" name="{$CurrPlanetInfo.irs_cry}">{$CurrPlanetInfo.crystal_type}</h3></td>
		<td class="semi_remarcado"><h3 class="tooltip" name="{$CurrPlanetInfo.irs_deu}">{$CurrPlanetInfo.deuterium_type}</h3></td>
		<td class="remarcado"><h3 class="tooltip" name="{$CurrPlanetInfo.irs_nor}">{$CurrPlanetInfo.norio_type}</h3></td>		
		<td class="semi_remarcado"><h3>{$CurrPlanetInfo.energy_type}</h3></td>
		<td>
			{html_options name=$CurrPlanetInfo.name  style="background-color: black;" options=$option selected=$CurrPlanetInfo.optionsel}
		</td>
	</tr>
    {/foreach}
	<tr>
