...
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
              <span><b><font color=yellow size = 2>{$fl_send_equipe}</font></b>
			  <b><a class="right" href="game.php?page=etoile1"><b><font color="red" size = 2>>></font><font size = 2> {$al_back}</font></b></a></b></span>
        </li>                                    
    </ul>
</div>
<div id="eins">
...
{/if}	
{if $PE_autreplapla > 0 }		
<form action="game.php?page=etoile3" method="post">
...
<div id="titulo_alternativo_secundario">
    <ul class="tabsbelow">
        <li>
              <span><b><font color=yellow size = 2>{$fl_mission}</font></b></span>
        </li>                                    
    </ul>
</div>
<div id="eins">
...
<td style="width:50%;margin:0;padding:0;">
        		<table width="270px"><tr>
					...
					{/foreach}	
						<tr>
							{if $MissionID == 15}<center><div id="bl3" style="visibility:visible"><font size=3 color=yellow>{$fl_expedition_alert_message1}</div><br />{/if}
