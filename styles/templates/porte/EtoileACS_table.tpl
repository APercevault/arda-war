...
<br />	
	<table>
		...
		<tr>
			...
			<td>
				<input name="addtogroup" type="text"><br><input class="submit" type="submit" value="{$fl_continue}">
			</td>
		</tr>
	</table>
</form>
...
function Rename(){
	...
	$.get('?page=etoile&action=getakspage&fleetid={$fleetid}&name='+Name, function(data) {
		if(data != "") {
			Dialog.alert(data);
			return;
		}
