...
<div id="topnav" class="header_normal"> 	
		{include file="overall_topnav.tpl"}	
			...
			<div id="estructura_titular" style="position:relative;">
				<div id="titular_texto" style="display: block;">{$fl_send_equipe}</div>
			</div>
        </div>
	</div> 
...
<div id="titulo_alternativo_corto">
    <ul class="tabsbelow">
        <li>
     <span><b><font color=yellow size = 2>{$fl_send_equipe}</font></b> <a class="right" href="game.php?page=etoile"><b><font color="red" size = 2>>></font> <font size = 2>{$al_back}</font></b></a></span>
        </li>                                    
    </ul>
</div>
<div id="eins">
        <div>	<br />
<form action="game.php?page=etoile2" method="post" onsubmit="return CheckTarget1()" id="form">
		...
		<table class="datos_vuelo" >
		   <tr>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <select visibility: hidden name="planettype" style="background-color: black;" onChange="updateVars()" onKeyUp="updateVars()">
                    {html_options options=$options_selector selected=$options}
                    </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<select visibility: hidden name="speed" style="background-color: black;" onChange="updateVars()" onKeyUp="updateVars()">
...
{if $ColonyRow.planet_type == 1}			
			<td><a href="javascript:setTarget({$ColonyRow.galaxy},{$ColonyRow.system},{$ColonyRow.planet},{$ColonyRow.planet_type});updateVars();"><img width="50" height="50" border="0" src="{$dpath}planeten/small/s_{$ColonyRow.image}.jpg" alt="{$ColonyRow.name}" /><br /><b>{$ColonyRow.name}</b> <br />{if $ColonyRow.planet_type == 3}{$fl_moon_shortcut}
			{/if}[{$ColonyRow.galaxy}:{$ColonyRow.system}:{$ColonyRow.planet}]</a></td>
{/if}			
