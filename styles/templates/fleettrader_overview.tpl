...
<div id="titulo_alternativo">
    <ul class="tabsbelow">
        <li>
<span><B><font color =yellow size = 2>{$comerciante}</font><font size = 2>{$taxecommercant}</font><font color = white size = 2>{$Charge}%</font></B> <a class="right" href="game.php?page=mercado"><b><font color="red" size = 2>>></font> <font size = 2>{$al_back}</font></b></a></span>	
        </li>                                    
    </ul>
</div>
<div id="eins">
