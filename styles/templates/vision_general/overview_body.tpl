...
<div id="titulo_alternativo">
    <ul class="tabsbelow">
        <li>
              <span><b><font color = yellow size = 2>{$ov_news}</font> </b></span>
        </li>                                    
    </ul>
</div>
<div id="eins">
        <div><br />
                    <table width="95%">
                         <tbody>
							<tr class="alt">
                           <th> <marquee scrolldelay="150"><font color = lime size = 2>{$news}</font></marquee></th>
                        </tr>
					{if $Teamspeak}
					<tr>
                        <td>
...
<tr>
<td><center><br /><FONT color="yellow">{$NewsRow.title}</FONT></td>
</tr>
<tr>
<td><center>{$NewsRow.text}</td>
</tr>
<tr>
<td><center><FONT color="red"> &nbsp;{$NewsRow.user}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$NewsRow.date}</FONT></td>
</tr>
{/foreach}
...
<div id="titulo_alternativo_secundario">
    <ul class="tabsbelow">
        <li>
              <span><b><font color = yellow size = 2>{$ov_events}</font> </b></span>
        </li>                                    
    </ul>
</div>
<div id="eins">
        <div><br />
{foreach name=AllyA item=AllyRow from=$Ally}
<center>
<tr><td colspan="3"><font style="color: #B0D8E8;">{$spatial}</font><font style="color:red;">{$attention}</font> <font style="color:yellow;">{$AllyRow.name} ({$AllyRow.koords})</font><font style="color:red;">{$par}</font> <font style="color:yellow;">{$AllyRow.attackername} ({$AllyRow.attackerkoord})</font></td></tr>
{/foreach}	
<br />
<tr><td colspan="3"><font style="color:yellow;">{$barre}</font> </td></tr>			
<table width="95%">
    <tbody>	
...
<div id="dialog" title="{$ov_planetmenu}" style="display:none;">
	<div id="tabs">
		...
		<div id="tabs-1">
			<label for="newname"> </label><input class="left campo_comun" type="text" name="newname" id="newname" size="25" maxlength="15" autocomplete="off">
		</div>
