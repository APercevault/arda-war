Message = {
        ...
        GenerateMessages: function () {
                ...
                if(Message.MessID != 999 && Message.MessID != 50) {
                        ...
                        HTML += '<option value="deletemarked" style="background-color: black;">'+Message.LNG.mg_delete_marked+'</option>';
                        HTML += '<option value="deleteunmarked" style="background-color: black;">'+Message.LNG.mg_delete_unmarked+'</option>';
                        HTML += '<option value="deletetypeall" style="background-color: black;">'+Message.LNG.mg_delete_type_all+'</option>';
                        HTML += '<option value="deleteall" style="background-color: black;">'+Message.LNG.mg_delete_all+'</option>';
                        HTML += '</select>';
