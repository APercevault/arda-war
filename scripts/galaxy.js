...
function doitetoile (order, galaxy, system, planet, planettype, shipcount) {
	$.post("game.php?page=etoileajax&ajax=1", {mission: order, galaxy: galaxy, system: system, planet: planet, planettype:  planettype, ships: shipcount}, function(data){
		retVals   	= data.split("|");
		Message   	= retVals[0];
		Infos     	= retVals[1];
		retVals   	= Infos.split(" ");
