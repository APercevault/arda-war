...
function BuildlistShipyard() {
	...
	if (s <= 0) {
		...
		$('#val_'+Shipyard[0][3]).text(function(i, old){
			return NumberGetHumanReadable(MaxQueue++);
		})	
	...
	element.html("<img src=styles/theme/"+data.skin_raza+"/gebaeude/"+Shipyard[0][3]+".png width=140 height=140 /><br /><b>"+Shipyard[0][0]+"</b>: "+GetRestTimeFormat(s));
